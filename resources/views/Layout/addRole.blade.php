    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <form action="{{URL::asset(route('addRole'))}}" method="POST">
                    @csrf
                    <h1 style="text-align: center;margin-top: 50px">FORM ADD ROLE</h1>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name Role</label>
                      <input type="test" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Name Role" required>
                    </div>
                    <div class="form-group">
